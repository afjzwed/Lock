...
//        mFilePath = "/data/data/com.tencent.devicedemo/files/photo.bmp";
        ...
        view = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                AFD_FSDKError err = engine.AFD_FSDK_InitialFaceEngine(Constant.arc_appid, Constant.fd_key,
                ...
                if (!result.isEmpty()) {
                    ...
                    AFR_FSDKError error1 = engine1.AFR_FSDK_InitialEngine(Constant.arc_appid, Constant.fr_key);
